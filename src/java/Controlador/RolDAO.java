...
public class RolDAO {
    ...
    public int actualizar(int id, String nuevoNombre) {
        String sql = "UPDATE Rol SET nombre_rol = ? WHERE idRol = ?";
        try {
            con = conectar.getConexion();
            ps = con.prepareStatement(sql);
    ...
    public int eliminar(int id) {
        ...
        try {
            ...
            System.err.println("Error de Integridad: No se puede eliminar un rol que ya tiene usuarios asignados.");
            return 0;
        }
    }
}