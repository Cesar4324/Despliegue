...
public class MarcaDAO {
    ...
    // --- 1. AGREGAR (Create) ---
    public int agregar(String nombreMarca) {
    ...
    public List<Object[]> listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                fila[0] = rs.getInt("idMarca");
                fila[1] = rs.getString("nombre_marca");
                datos.add(fila);
            }
        } catch (SQLException e) {
    ...
    public int actualizar(int id, String nuevoNombre) {
        String sql = "UPDATE Marca SET nombre_marca = ? WHERE idMarca = ?";
        try {
            con = conectar.getConexion();
            ps = con.prepareStatement(sql);
    ...
    public int eliminar(int id) {
        ...
        try {
            ...
            System.err.println("Error de Integridad: No se puede eliminar una marca que ya tiene productos asociados.");
            return 0;
        }
    }
}